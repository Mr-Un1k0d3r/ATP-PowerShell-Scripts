...
try {
    $ModelAndVendor= Get-WmiObject Win32_ComputerSystem | Select-Object Manufacturer,SystemFamily,HypervisorPresent,Model,PCSystemType -Unique -First 1
}
catch {
    exit
}
...
try {
    $NetworkInterfaces = @(Get-NetAdapter | select Name, InterfaceDescription, MacAddress, InterfaceType, PhysicalMediaType)
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAAZMzThp7JxnYb
# +BOCLsbHiVJd5a52sMdWUMR6zpNNTqCCDZcwggYVMIID/aADAgECAhMzAAADEBr/
...
# LwYJKoZIhvcNAQkEMSIEIMnxOp+OL5ro9QtA53BZnQWqBeZGH2UTtJ91YTJ6uXND
# MEIGCisGAQQBgjcCAQwxNDAyoBSAEgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRw
# Oi8vd3d3Lm1pY3Jvc29mdC5jb20wDQYJKoZIhvcNAQEBBQAEggEAddEiNAMtSd39
# 0ob3HHwClSptoYIZUGo5DLdCv3Ldu0VNUjLOys3ZSvcr0FeG9BEukJgxRXcyZdXp
# EGtptSyI9dGDPxiK2bXPdRAe6Hf8Ju2h9y4Hzz6r0TDcs5KSkzo6LkYKNPPpafcm
# HkYBOhTxmvbW9QYOYF1fHY+HiRvr8y5EOBP8PmcTVM852YdGpNpJ2fOSMlQdBqUo
# 2xMgkCQXSrLpzqufnGfLII9LHIi5t3JrgZdXM3B1UpdSyVHkbsbLacD7VFkp7N21
# NjGDSizwZslCLee1eTa8qJpBUKtPd0bqJBNJkSwSTvaLCOLwM+tmhOPq5hTsmSjK
# FvD0u49hnKGCFxYwghcSBgorBgEEAYI3AwMBMYIXAjCCFv4GCSqGSIb3DQEHAqCC
# Fu8wghbrAgEDMQ8wDQYJYIZIAWUDBAIBBQAwggFZBgsqhkiG9w0BCRABBKCCAUgE
# ggFEMIIBQAIBAQYKKwYBBAGEWQoDATAxMA0GCWCGSAFlAwQCAQUABCCvxiXYZIcO
# p3uc4p4uRLPN2XkjyvVUDMKVKcnj7z9XagIGYxIQ/ZiuGBMyMDIyMDkyMDA5NTcx
# OC4xMjdaMASAAgH0oIHYpIHVMIHSMQswCQYDVQQGEwJVUzETMBEGA1UECBMKV2Fz
...
# MC8GCSqGSIb3DQEJBDEiBCBKAxDbzaOSU58eijm6jsZkFe/MgEOnWhWuCLZT3L35
# MDCB+gYLKoZIhvcNAQkQAi8xgeowgecwgeQwgb0EIL0FjyE74oGlLlefn/5VrNwV
...
# zIEqHrS/4eZLk890MPcwDQYJKoZIhvcNAQELBQAEggIAj8VifOp5z0YLbrLUP9C0
# CGLaqhlPdsLJesR1mUOt/CucYUhEYCaQXf6kwmC07lVtrbhI8ME3YIw4msjy3CR7
# Ywa/TXzTIIkeKQUfmITMiwLkp+hkYkkiJeoSrakqSeturVRSPhAuEU4FtpY6jG72
# fUOxIgNMWOWyxDnd/tG8q6+IHoEavqjnIEiv/LaAxGZ0tUxakO8BQZporiJ8mTE5
# rOpM6uWUU3QVcLaec+NXzgPWX8sxufa4UTi3dJBzBdEu+atoUW/k0DP42t0rIJ2b
# c+WoiVMo3xVwiU8y+ef2okUbz1HkTrmzOfOo8M5e8756673NjkeHY7WY/fT74xx1
# echxwqiDJooSy+/zdxw6IAkQU7xBVmGWGMouAf4e/8fOFvby9/Z3v3LQMjKoWDFN
# Hd+wGdiiOajpPEl0a+WUBIjgnhMemJ9OjrwaMsSBxqcFqO5WfwxeiZe+w22IGh7C
# 9gUMRxbvbwzAQtryzXulf2Mu3FGe+o5sUeC7P3yHFHeMCH+4hzODPEBP8vSdnIsg
# D3tasNlskjlgoMyqesTzSQ6Q9OHdnDmw/Oxptc3ZRcKa9mNt6W1g8G7Z1AdLa5m8
# rY5gDmNKRZSenfWj1+/wy0ip5vxqH4NR8ss7mWEC0mH9T7si0cxncUuT6COZ3hXy
# 8vo3Kzxwv+kMYcoFOk/EZRM=
